...
(function (TProject) {
    ...
    var SimpleButton = (function (_super) {
        ...
        function SimpleButton(game, code, sticky, x, y) {
            ...
            var _this = this;
            var char = "";
            _this = _super.call(this, game.game, x, y, "left") || this;
            switch (code) {
...
(function (TProject) {
    ...
    var OverlayButton = (function (_super) {
        ...
        function OverlayButton(game, dbSprite, btnWidth, btnHeight, states, cb, context) {
            ...
            _this._btnOverlay.beginFill(0x000000, 0.5);
    ...
    var BaseGame = (function (_super) {
        ...
        BaseGame.prototype.setGameData = function (characterId, currentLevel, currentLocation) {
            ...
            if (!this.game.device.desktop) {
                ...
                this._rightButton.setPos(TProject.GameConfig.screenWidth - 10 - 64, this.game.world.centerY);
        ...
        BaseGame.prototype.update = function () {
            ...
            if (!this._gameStarted)
                return;
            if (this._bod.pY > 5 && !this._timerOn) {
                this._timerOn = true;
            }
...
(function (TProject) {
    var MainMenuScreen = (function (_super) {
        ...
        MainMenuScreen.prototype.myinit = function () {
            ...
            this._chooseWorld = 1;
            this._chooseLevel = 0;
            this._choosePlayer = 1;
            this._lastWorld = 1;
            this._lastWorldStatus = false;
            this._levelsStatusArray = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
            this._levelsShowOpenedArray = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
            ...
            this._bgForMenu = this.game.add.sprite(0, 0, "ImagesForBG", "MenuBG");
            this._mainMenuBG = this.game.add.sprite(0, 0, "ImagesForBG", "mainMenuBG");
            this._helpBtn = new TProject.OButton(this.game, "ImagesForBG", ["instructions_btn_10001", "instructions_btn_10002", "instructions_btn_10002"], function () {
            ...
            this._playBtn = new TProject.OButton(this.game, "ImagesForBG", ["play_btn_10001", "play_btn_10002", "play_btn_10002"], function () {
                _this._helpBtn.enabled = false;
                _this._playBtn.enabled = false;
                _this._mainMenuBG.visible = false;
        ...
        MainMenuScreen.prototype.initPickWorld = function () {
            ...
            this._overlayForMenu = this.game.add.sprite(4, 4, "ImagesForBG", "MenuOverlay");
            this._planeWorldSelect = this.game.add.sprite(0, 0, "ImagesForBG", "chooseLocationPanel");
                ...
                switch (this._lastWorld) {
                    case 1:
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_1_open");
                    ...
                    case 2:
                        this.worldIsOpen(1);
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_2_open");
                    ...
                    case 3:
                        ...
                        this.worldIsOpen(2);
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_3_open");
        ...
        MainMenuScreen.prototype.initPickLevel = function () {
            ...
            this._overlayForLevel = this.game.add.sprite(4, 4, "ImagesForBG", "MenuOverlay");
            this._planeLevelSelect = this.game.add.sprite(0, 0, "ImagesForBG", "chooseLevelPanel");
        ...
        MainMenuScreen.prototype.initChooseCharacter = function () {
            ...
            this._overlayForPlayer = this.game.add.sprite(4, 4, "ImagesForBG", "MenuOverlay");
            this._planeCharacterSelect = this.game.add.sprite(0, 0, "ImagesForBG", "choosePlayerPanel");
            ...
            this._characterDoneOver = new TProject.OverlayButton(this.game, buttonDBTest, 240, 90, ["up", "over", "up", "over"], function () {
                ...
                console.log("PLAY GAME! World: " + _this._chooseWorld + " Level: " + _this._chooseLevel + " Char: " + _this._choosePlayer);
            }, this);
        ...
        MainMenuScreen.prototype.initInstructions = function () {
            ...
            this._overlayForInstructions = this.game.add.sprite(4, 4, "ImagesForBG", "MenuOverlay");
            this._planeInstructions = this.game.add.sprite(0, 0, "ImagesForBG", "InstructionsPanel");
        ...
        MainMenuScreen.prototype.setDragToObject = function (sprite) {
            sprite.inputEnabled = true;
            sprite.input.enableDrag();
            sprite.events.onDragStop.add(this.onDragStop, this);
        };
        MainMenuScreen.prototype.onDragStop = function (sprite) {
...
(function (TProject) {
    var Preloader = (function (_super) {
        ...
        Preloader.prototype.preload = function () {
            ...
            this.game.load.image("right", TProject.Boot.PATH_IMAGES + "right.png");
            this.game.load.image("left", TProject.Boot.PATH_IMAGES + "left.png");
            ...
            this.game.load.atlas("ImagesForBG", TProject.Boot.PATH_IMAGES + "ImagesForBG.png", TProject.Boot.PATH_IMAGES + "ImagesForBG.json");
