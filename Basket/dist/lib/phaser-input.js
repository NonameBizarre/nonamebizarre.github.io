...
(function (PhaserInput) {
    var InputField = (function (_super) {
        ...
        function InputField(game, x, y, inputOptions) {
            ...
            _this.domElement = new PhaserInput.InputElement(_this.game, 'phaser-input', _this.inputOptions.type, _this.value);
            ...
            this.events.onInputDown.add(_this.checkDown, _this);
            this.timerTest = 0;
/*
            _this.domElement.focusOn.add(function () {
                console.log("ups");
