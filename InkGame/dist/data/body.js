...
(function (TProject) {
    var GameUI = (function (_super) {
        ...
        function GameUI(game, body) {
            ...
            this._result = this.game.add.text(this.game.world.width / 2, 420, "correct", { font: "Poppins", fontSize: "45px", fontWeight: "bold", fill: "#33cc33" });
            ...
            this._playerLiveSprite[0] = this.game.add.sprite(this.game.world.width - 130, 15, "main", "levelCross0000");
            this._playerLiveSprite[1] = this.game.add.sprite(this.game.world.width - 90, 15, "main", "levelCross0000");
        ...
        GameUI.prototype.restart = function () {
            this._playerLiveSprite[0].alpha = 0.3;
            this._playerLiveSprite[1].alpha = 0.3;
            this._playerLiveSprite[2].alpha = 0.3;
        ...
        GameUI.prototype.incorrectResult = function () {
            ...
            if (!this._endGame) {
                ...
                this._result.fill = "#fe871a";
                TProject.Config.audio.play("error", 0.6);
                this.tweenTint(this._question, 0xaaaaff, 0xff0000, 600);
                this.game.add.tween(this._result).to({ alpha: 1 }, 650, Phaser.Easing.Sinusoidal.Out, true).onComplete.add(function () {
                    ...
                    _this.tweenTint(_this._question, 0xff0000, 0xaaaaff, 300); //this._question.tint = 0xaaaaff;
                });
            }
        };
        ...
        GameUI.prototype.playerCollideCheck = function (player) {
            for (var i = 0; i < this._numberArray.length; i++) {
                if (this.game.physics.arcade.collide(player, this._numberArray[i]) && this._numberArray[i].alpha != 0 && !this._endGame) {
    ...
    var NumberObject = (function (_super) {
        ...
        function NumberObject(game, x, y, currentNumber) {
            ...
            this.alpha = 0;
            this._currentText = this.game.add.text(0, 0, this._currentNumber, { font: "Poppins", fontSize: "45px", fontWeight: "bold", fill: "#33cc33" });
...
(function (TProject) {
    var Player = (function (_super) {
        ...
        function Player(game, x, y, cnt, body) {
            ...
            this._grabTextObject = this.game.add.text(0, this.height - 40, "", { font: "Poppins", fontSize: "45px", fontWeight: "bold", fill: "#33cc33" });
            ...
            this._textObjectText = this.game.add.text(0, 0, "", { font: "Poppins", fontSize: "45px", fontWeight: "bold", fill: "#33cc33" });
            this._textObjectText.anchor.set(0.5);
            this._textObjectDropContainer.addChild(this._textObjectText);
            this._smoke2 = new TProject.SmokeObject(game);
...
(function (TProject) {
    var Body = (function (_super) {
        ...
        Body.prototype.create = function () {
            ...
            this._gameOver = false;
            var floor = this.game.add.image(this.world.centerX, this.game.height, "main", "floor0000");
            ...
            container.addChild(this._gameUI);
...
(function (TProject) {
    var Boot = (function (_super) {
        ...
        Boot.prototype.create = function () {
            ...
            this.game.stage.backgroundColor = "#FAAC5A";
