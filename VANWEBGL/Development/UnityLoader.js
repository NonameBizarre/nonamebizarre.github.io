...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'VANWEBGL.data';
    var REMOTE_PACKAGE_BASE = 'VANWEBGL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4627851;
      var PACKAGE_UUID = '77f57015-4d65-4998-99ea-14830f1a92ff';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 637973, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(637973, 638706, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(638706, 645577, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(645577, 3103533, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3103533, 4600225, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4600225, 4627851, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_VANWEBGL.data');

    };
    Module['addRunDependency']('datafile_VANWEBGL.data');
