...
(function (TProject) {
    var Bod = (function (_super) {
        ...
        Bod.prototype.hitNormal = function () {
            var tHit = Math.round(Math.random() * 3);
            this._hitAnimations[tHit].play(24 * 2, false);
            var randNum = Math.random();
            if (randNum < 0.5) {
                TProject.SoundMixer.play("sound 25 (sfx_ow1)", 0.6);
            }
            else {
                TProject.SoundMixer.play("sound 24 (sfx_ow2)", 0.6);
            }
        };
        ...
        Bod.prototype.hitScream = function () {
            ...
            if (this._characterId == 1) {
                TProject.SoundMixer.play("sound 23 (sfx_scream_1)", 0.6);
            }
            else if (this._characterId == 2) {
                TProject.SoundMixer.play("sound 21 (sfx_scream_2)", 0.6);
            }
            else {
                TProject.SoundMixer.play("sound 20 (sfx_scream_3)", 0.6);
            }
        };
        ...
        Bod.prototype.nudge = function (tx, dt) {
            ...
            if (this._turningSound1Playing && this._state == "gameover") {
                TProject.SoundMixer.stop("sound 32 (sfx_skiturnhard1)");
                this._turningSound1Playing = false;
            }
            if (this._turningSound2Playing && this._state == "gameover") {
                TProject.SoundMixer.stop("sound 31 (sfx_skiturnhard2)");
                this._turningSound2Playing = false;
            }
            if (this.pY < 0) {
                tx = 0;
            ...
            if (this._hitDelay > 0) {
                ...
                if (this._angle > 180 + turnSoundThreshold) {
                    if (this._turningSound1Playing == false) {
                        TProject.SoundMixer.play("sound 32 (sfx_skiturnhard1)", 0.6);
                        this._turningSound1Playing = true;
                    }
                }
                else if (this._angle < 180 - turnSoundThreshold) {
                    if (this._turningSound2Playing == false) {
                        TProject.SoundMixer.play("sound 31 (sfx_skiturnhard2)", 0.6);
            ...
            this._dirY = (this._speed + speedBoostValue) * ttY * Bod.SPEED_COEFF;
            this.pX += this._dirX;
            this.pY += this._dirY;
            if (this._jumpSpeed > 0) {
                this._heightOffGround += this._jumpSpeed * Bod.SPEED_COEFF;
            }
            else {
                if (this._heightOffGround > 0) {
                    this._heightOffGround += this._jumpSpeed * Bod.SPEED_COEFF;
            ...
            if (this._heightOffGround <= 0) {
                ...
                this._jumpSpeed += -0.3 * TProject.GameConfig.gravitySpeed * Bod.SPEED_COEFF;
                this._jumpSpeed += -0.0075 * this._heightOffGround * TProject.GameConfig.gravitySpeed * Bod.SPEED_COEFF;
            }
        ...
        Bod.prototype.destory = function () {
            if (this._bodSnow) {
                this._bodSnow.destroy();
            }
...
(function (TProject) {
    var Cam = (function (_super) {
        ...
        function Cam(game, x, y) {
            ...
            ;
            _this._backgroundLayer = _this.game.add.sprite(0, 0);
            _this.addChild(_this._backgroundLayer);
        ...
        Cam.prototype.checkZOrder = function () {
            var _this = this;
            this._objArr.forEach(function (x) {
        ...
        Cam.prototype.update = function () {
            ...
            var tObj;
            var i = 0;
            while (i < this._objArr.length) {
                var el = this._objArr[i];
                el.setPos(this.pX, this.pY);
                if (el.y < -300) {
                    el.destroy();
...
(function (TProject) {
    var Obstacle = (function (_super) {
        ...
        Object.defineProperty(Obstacle.prototype, "isVisible", {
            get: function () {
        ...
        Obstacle.prototype.createGraphics = function () {
            switch (this._obstacleType) {
                ...
                case "Grass1":
                    ...
                    break;
                case "Tree1":
                    this._graphicalMovieObject = this.game.add.sprite(0, 0, "GameAssets", "rockMC_20001");
                    this._graphicalObject = new Phaser.Circle(0, 0, this._radius * 2);
                    this._graphicalMovieObject.anchor.set(0.5, 0.61);
                    this.createAnimation("rockMC_", this._graphicalMovieObject, 20002, 20010, 20001);
                    break;
                case "Tree":
                    var treeType = void 0;
                    var randNum = Math.random();
                ...
                case "Rock":
                    this._graphicalObject = new Phaser.Circle(0, 0, this._radius * 2);
                    randNum = Math.random();
                    this._graphicalMovieObject = this.game.add.sprite(0, 0, "GameAssets", "rockMC_30001");
                    this._graphicalMovieObject.anchor.set(0.5, 0.61);
                    this._graphicalMovieObject.y = 20;
                    this.createAnimation("rockMC_", this._graphicalMovieObject, 30002, 30010, 30001);
                    break;
                case "Grass":
                    this._graphicalObject = new Phaser.Circle(0, 0, this._radius * 2);
                    randNum = Math.random();
...
(function (TProject) {
    ...
    var SimpleButton = (function (_super) {
        ...
        function SimpleButton(game, code, sticky, x, y) {
            ...
            var _this = this;
            var char = "";
            _this = _super.call(this, game.game, x, y, "GUI_Test", "mobile_button") || this;
            switch (code) {
...
(function (TProject) {
    var SaveData = (function () {
        function SaveData() {
            ...
            this.choosePlayer = 1;
            this.winMedal = 0;
            this.currentMenuState = "MainMenuScreen";
            this.lastWorld = 1;
            this.lastWorldStatus = false;
            this.levelsStatusArray = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
            this.levelsShowOpenedArray = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
...
(function (TProject) {
    var OButton = (function (_super) {
        ...
        OButton.prototype.over = function () {
            ...
            this._isOver = true;
            TProject.SoundMixer.play("sound 11 (sfx_button_over)", 0.5);
        };
        ...
        OButton.prototype.up = function () {
            ...
            if (tap && this._cb != null) {
                TProject.SoundMixer.play("sound 13 (sfx_button)", 0.5);
                if (this._cntxt)
...
(function (TProject) {
    var ButtonState = (function () {
        function ButtonState(up, over, out, down) {
            this.up = up;
            this.over = (over == null ? up : over);
            this.out = (out == null ? up : out);
            this.down = (down == null ? up : down);
            this.scaleDefault = 1.0;
            this.scaleDown = 1.0;
            this.scaleOver = 1.0;
        }
        ButtonState.prototype.setScale = function (def, down, over) {
            this.scaleDefault = def ? def : 1.0;
            this.scaleDown = down ? down : 1.0;
            this.scaleOver = over ? over : 1.0;
        };
        return ButtonState;
    }());
    var OverlayButton = (function (_super) {
        __extends(OverlayButton, _super);
        function OverlayButton(game, dbSprite, btnWidth, btnHeight, states, cb, context) {
            var _this = _super.call(this, game, 0.0, 0.0) || this;
            _this.soundDown = "button_click";
            _this._activeEndAnimation = true;
            _this._visual = dbSprite;
            _this._btnOverlay = new Phaser.Graphics(_this.game, 0, 0);
            _this._btnOverlay.beginFill(0x000000, 0);
            _this._btnOverlay.drawRect(0, 0, btnWidth, btnHeight);
            _this._btnOverlay.endFill();
            _this.addChild(_this._btnOverlay);
            _this._cb = cb;
            _this._cntxt = context;
            _this._states = new ButtonState(states[0], states[1], states[2], states[3]);
            _this._visual.play(_this._states.up);
            _this.inputEnabled = false;
            _this._isDown = false;
            _this._isOver = false;
            _this.enabled = true;
        ...
        OverlayButton.prototype.setScaleForAnimation = function (down, over, def) {
            this._states.setScale(def, down, over);
        };
        OverlayButton.prototype.over = function () {
            this._visual.play(this._states.over);
            this._isOver = true;
            TProject.SoundMixer.play("sound 11 (sfx_button_over)", 0.5);
            this._visual.scale.set(this._states.scaleOver, this._states.scaleOver);
        };
        OverlayButton.prototype.out = function () {
            if (!this._isOver) {
                return;
            }
            this._isOver = false;
            ...
            this._visual.play(this._states.out);
            this._visual.scale.set(this._states.scaleDefault, this._states.scaleDefault);
        };
        OverlayButton.prototype.down = function () {
            if (this._isDown) {
                return;
            }
            TProject.SoundMixer.play("sound 13 (sfx_button)", 0.5);
            this._visual.play(this._states.down);
            this._isDown = true;
            this._visual.scale.set(this._states.scaleDown, this._states.scaleDown);
        };
        OverlayButton.prototype.up = function () {
            if (!this._isDown) {
                return;
            }
            this._isDown = false;
            ...
            if (this._isOver) {
                ...
                this._visual.play(this._states.up);
                this._visual.scale.set(this._states.scaleDefault, this._states.scaleDefault);
            }
        };
        Object.defineProperty(OverlayButton.prototype, "activeEndAnimation", {
            set: function (value) {
                this._activeEndAnimation = value;
            },
            enumerable: true,
            configurable: true
        });
        OverlayButton.prototype.setPos = function (x, y) {
            this.x = x ? x : this.x;
            this.y = y ? y : this.y;
        };
        Object.defineProperty(OverlayButton.prototype, "enabled", {
            get: function () {
                return this.inputEnabled;
            },
            set: function (value) {
                ...
                if (value) {
                    ...
                    setTimeout(function () {
                        if (_this._activeEndAnimation)
                            _this._visual.play(_this._states.up);
                    }, 10);
                    this.events.onInputOver.removeAll(this);
                    this.events.onInputOut.removeAll(this);
                    this.events.onInputDown.removeAll(this);
                    this.events.onInputUp.removeAll(this);
    ...
    TProject.OverlayButton = OverlayButton;
})(TProject || (TProject = {}));
...
(function (TProject) {
    var SoundMixer = (function () {
        ...
        SoundMixer.play = function (key, volume, bgMusic, loop) {
            ...
            if (TProject.Boot.GAME_DATA.musicEnable == false) {
                if (bgMusic) {
        ...
        SoundMixer.stop = function (key) {
            SoundMixer._audio.stop(key);
        };
        SoundMixer.on = function () {
            if (SoundMixer._bgKey) {
                SoundMixer.play(SoundMixer._bgKey, SoundMixer._bgVolume);
            }
        };
...
(function (TProject) {
    ...
    LocalConfig.CURRENT_STATE = "MainMenuScreen";
...
(function (TProject) {
    var Main = (function () {
        function Main() {
            ...
            this.game.state.add("MainMenuScreen", TProject.MainMenuScreen);
            this.game.state.add("EndGameScreen", TProject.EndGameScreen);
        }
...
(function (TProject) {
    var BaseGame = (function (_super) {
        ...
        BaseGame.prototype.create = function () {
            ...
            TProject.Boot.GAME_DATA.currentMenuState = "MainMenuScreen";
            TProject.SaveManager.getInstance.save();
            TProject.SoundMixer.off();
            TProject.SoundMixer.play("sound 1 (sfx_windloop)", 0.6, true);
            this._stepsCounter = 0;
            this.setDebugMode();
            this.setGameData(TProject.Boot.GAME_DATA.choosePlayer, TProject.Boot.GAME_DATA.chooseLevel, TProject.Boot.GAME_DATA.chooseWorld);
        };
        BaseGame.prototype.myinit = function () {
            _super.prototype.init.call(this);
            var currentLevel = this.getCurrentLevel();
            this._obstacleArray = TProject.GameConfig.getObstableData(currentLevel).slice();
        ...
        BaseGame.prototype.setGameData = function (characterId, currentLevel, currentLocation) {
            ...
            this._currentStarsText = this.game.add.text(76, 79, this._numberItems.toString(), {
                font: TProject.Boot.FONT_NAME_MEDIUM,
                fontSize: "25px",
                fontWeight: "normal",
                fill: "#ffffff",
                align: "left",
            ...
            this._currentTimeText = this.game.add.text(55, 78, "00:00", {
                font: TProject.Boot.FONT_NAME_MEDIUM,
                fontSize: "25px",
                fontWeight: "normal",
                fill: "#ffffff",
            ...
            this._testBigFoot = new TProject.DBSprite(TProject.Boot.TEST_BIGFOOT, "mc/all levels/Hector movie 0" + this._currentLocation + " with shake", this.game);
            this._testBigFoot.setPos(385.0 - 10, 170.0);
            this._testBigFoot.addEvent("frameEvent", function (ev) {
                if (ev.name === "step") {
                    _this._stepsCounter += 1;
                    if (_this._stepsCounter % 2 == 0) {
                        TProject.SoundMixer.play("sound 18 (sfx_step1)", 0.6);
                    }
                    else {
                        TProject.SoundMixer.play("sound 19 (sfx_step2)", 0.6);
                    }
                }
            });
            this._testBigFoot.play("idle", function () {
                if (_this._testBigFoot) {
                    _this._testBigFoot.free();
                }
                ...
                _this._currentTween = _this.game.add.tween(_this._lightPlank).to({ y: -87 }, 600, Phaser.Easing.Sinusoidal.InOut, true, 1500);
                _this._currentTween.onComplete.addOnce(function () {
                    _this.setTimeout(function () {
                        TProject.SoundMixer.play("sound 12 (sfx_startlight1)", 0.6);
                        ...
                        _this.setTimeout(function () {
                            ...
                            _this.setTimeout(function () {
                                ...
                                _this.setTimeout(function () {
                                    TProject.SoundMixer.play("sound 15 (sfx_startlight2)", 0.6);
                                    TProject.SoundMixer.play("sound 16 (music_game)", 0.6, true);
                                    TProject.SoundMixer.play("sound 1 (sfx_windloop)", 0.6, false, true);
                                    _this._lightPlank.frameName = "ligths_export_10005";
                                    _this.setTimeout(function () {
                                        if (_this._characterSelcted == 1) {
                                            TProject.SoundMixer.play("sound 7 (sfx_laugh_1)", 0.6);
                                        }
                                        else if (_this._characterSelcted == 1) {
                                            TProject.SoundMixer.play("sound 3 (sfx_laugh_2)", 0.6);
                                        }
                                        else {
                                            TProject.SoundMixer.play("sound 5 (sfx_laugh_3)", 0.6);
                                        }
                                    }, 600);
                                    _this._currentTween = _this.game.add.tween(_this._lightPlank).to({ y: -250 }, 600, Phaser.Easing.Sinusoidal.InOut, true, 800);
                                    _this._gameStarted = true;
                                    if (!_this.game.device.desktop) {
                                        _this._leftButton.enabled = true;
                                        _this._leftButton.visible = true;
                                        _this._rightButton.enabled = true;
                                        _this._rightButton.visible = true;
                                    }
                                }, 800);
                            }, 800);
                        }, 800);
            ...
            this._soundBtnOn = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_sound_10001", "mc.btn_sound_10002", "mc.btn_sound_10002"], function () {
                ...
                TProject.Boot.GAME_DATA.musicEnable = false;
                TProject.SaveManager.getInstance.save();
                TProject.SoundMixer.off();
            });
            this._soundBtnOn.position.set(720, 31);
            this._soundBtnOn.visible = false;
            this._soundBtnOn.enabled = false;
            ...
            this._soundBtnOff = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_sound_10003", "mc.btn_sound_10004", "mc.btn_sound_10004"], function () {
                ...
                TProject.Boot.GAME_DATA.musicEnable = true;
                TProject.SaveManager.getInstance.save();
                TProject.SoundMixer.on();
            });
            this._soundBtnOff.position.set(720, 31);
            this._soundBtnOff.visible = false;
            this._soundBtnOff.enabled = false;
            this.world.addChild(this._soundBtnOff);
            if (TProject.Boot.GAME_DATA.musicEnable) {
                this._soundBtnOn.visible = true;
                this._soundBtnOn.enabled = true;
            }
            else {
                this._soundBtnOff.visible = true;
                this._soundBtnOff.enabled = true;
            }
            this._exitBtn = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_exit_10001", "mc.btn_exit_10002", "mc.btn_exit_10002"], function () {
                TProject.Boot.GAME_DATA.currentMenuState = "MainMenuScreen";
                TProject.SaveManager.getInstance.save();
                _this.game.state.start("MainMenuScreen", true);
            });
            this._exitBtn.position.set(35, 31);
            this.world.addChild(this._exitBtn);
            if (!this.game.device.desktop) {
                this._leftButton = new TProject.SimpleButton(this, Phaser.Keyboard.LEFT, false);
                this._leftButton.setPos(32 + 10, this.game.world.centerY);
                this._rightButton = new TProject.SimpleButton(this, Phaser.Keyboard.RIGHT, false);
                this._rightButton.setPos(TProject.GameConfig.screenWidth - 10 - 70, this.game.world.centerY);
                this._rightButton.anchor.set(1, 0.5);
                this._leftButton.enabled = false;
        ...
        BaseGame.prototype.setObstacles = function () {
            ...
            var i = 0;
            var tObstacleArray = [];
            for (var i_1 = 0; i_1 < this._obstacleArray.length / 3; i_1++) {
                tType = this._obstacleArray[i_1 * 3];
                tX = this._obstacleArray[i_1 * 3 + 1];
                tY = this._obstacleArray[i_1 * 3 + 2];
                tObstacleArray.push([tType, tX, tY]);
            }
            tObstacleArray.sort(function (a, b) {
                return -(a[2] - b[2]);
            });
            this._obstacleArray = tObstacleArray;
            while (tObstacleArray.length > 0) {
                var data = tObstacleArray.pop();
                tType = data[0];
                pCX = data[1];
                pCY = data[2];
        ...
        BaseGame.prototype.collectGift = function () {
            ...
            TProject.SoundMixer.play("sound 17 (sfx_pickup)", 0.6);
            TProject.SoundMixer.play("sound 2 (sfx_star)", 0.6);
        ...
        BaseGame.prototype.update = function () {
            ...
            var counter = 0;
            while (this._obstacleArray.length > 0) {
                var data = this._obstacleArray[this._obstacleArray.length - 1];
                if (data[2] < this._bod.pY + 400) {
                    counter++;
                    var tType = data[0];
                    var pCX = data[1];
                    var pCY = data[2];
                    var pObstacle = new TProject.Obstacle(this.game, pCX, pCY);
                    pObstacle.mytype = tType;
                    this._cam.addObj(pObstacle, tType);
                    this._obstacleArray.pop();
                    pObstacle.setPos(this._cam.pX, 400);
                }
                else {
                    if (counter > 0) {
                        this._cam.checkZOrder();
                    }
                    break;
                }
            }
        ...
        BaseGame.prototype.gameOver = function () {
            ...
            TProject.SoundMixer.stop("sound 16 (music_game)");
            TProject.SoundMixer.play("sound 22 (sfx.airhorm)", 0.6);
            TProject.SoundMixer.play("sound 14 (music_gameover)", 0.6);
        ...
        BaseGame.prototype.createLevelEndPopup = function () {
            ...
            TProject.Boot.GAME_DATA.winMedal = medal;
            TProject.SaveManager.getInstance.save();
            this.game.state.start("FinishScreen", true);
        };
        ...
        BaseGame.prototype.clean = function () {
            ...
            if (this._currentTween) {
                this.tweens.remove(this._currentTween);
            }
            if (this._testBigFoot) {
                this._testBigFoot.free();
            }
            if (this._finishLine) {
                this._finishLine.parent.removeChild(this._finishLine);
                this._finishLine.destroy();
            }
            if (this._startLine) {
                this._startLine.parent.removeChild(this._startLine);
                this._startLine.destroy();
            }
            if (this._starBurst) {
                this._starBurst.parent.removeChild(this._starBurst);
                this._starBurst.destroy();
            }
            this._cam.destroy();
        };
...
(function (TProject) {
    var Boot = (function (_super) {
        ...
        Boot.prototype.initSaveManager = function () {
            TProject.SaveManager.getInstance.init("downhilldash_01", Boot.GAME_DATA);
    ...
    Boot.FONT_NAME_MEDIUM = "FredFredburgerAraHeadW21-Blk";
...
(function (TProject) {
    var EndGameScreen = (function (_super) {
        ...
        EndGameScreen.prototype.create = function () {
            var _this = this;
            _super.prototype.create.call(this);
            if (this.game.device.desktop) {
                this._max = 0;
                this._update_interval = 240;
            }
            this.setDebugMode();
            this._bg = this.game.add.sprite(-7, 0, "GUI_Test", "podium_bg");
            this.game.stage.addChild(this._bg);
            this._anais = this.game.add.sprite(409, 360, "finish_chars", "podium_anis_10001");
            ...
            this._darwin = this.game.add.sprite(282, 395, "finish_chars", "podium_darwin_10001");
            this._darwin.anchor.set(0.5, 1);
            this._darwin.scale.set(1.2, 1.2);
            ...
            this._gumball = this.game.add.sprite(185, 437, "finish_chars", "podium_gumball_10001");
            this._gumball.anchor.set(0.5, 1);
            this._gumball.scale.set(-1.25, 1.25);
            ...
            this._bgOverlay = this.game.add.sprite(137, -2, "GUI_Test", "fin_bg");
            this._bg.addChild(this._bgOverlay);
            this._starBoostArray = [];
            this.createStar(15, 149);
            this.createStar(311, 76);
            this.createStar(393, 198);
            this.createStar(530, 87);
            this.createStar(380, 416);
            this.createStar(257, 344);
            this.createStar(18, 326);
            this._contininiueBtn = new TProject.OButton(this.game, "GUI_Test", ["btn_continue_10001", "btn_continue_10002", "btn_continue_10002"], function () {
                ...
                _this._soundBtnOff.enabled = false;
                _this._soundBtnOn.enabled = false;
                _this._contininiueBtn.enabled = false;
                TProject.Boot.GAME_DATA.currentMenuState = "MainMenuScreen";
                TProject.SaveManager.getInstance.save();
                _this.setTimeout(function () {
                    _this.game.state.start("MainMenuScreen", true);
            ...
            this._contininiueBtn.position.set(622, 451);
            this._contininiueBtn.alpha = 0;
            this._contininiueBtn.enabled = false;
            this._bg.addChild(this._contininiueBtn);
            this.game.add.tween(this._contininiueBtn).to({ alpha: 1 }, 350, Phaser.Easing.Sinusoidal.In, true, 1500).onComplete.addOnce(function () {
            ...
            if (this.game.device.desktop) {
                this._snowEmmiter = this.game.add.emitter(this.game.world.centerX, -32, 150);
                this._snowEmmiter.makeParticles("GUI_Test", "snow_particle");
                this._snowEmmiter.maxParticleScale = 1;
                this._snowEmmiter.minParticleScale = 0.5;
                this._snowEmmiter.setYSpeed(100, 200);
                this._snowEmmiter.gravity = 0;
                this._snowEmmiter.width = this.game.world.width * 1.5;
                this._snowEmmiter.minRotation = 0;
                this._snowEmmiter.maxRotation = 40;
                this._snowEmmiter.start(false, 6000, 250);
                this._bg.addChild(this._snowEmmiter);
                this.changeWindDirection();
            }
        };
        EndGameScreen.prototype.changeWindDirection = function () {
            var _this = this;
            var multi = Math.floor((this._max + 200) / 4), frag = (Math.floor(Math.random() * 100) - multi);
            this._max = this._max + frag;
            if (this._max > 200)
                this._max = 150;
            if (this._max < -200)
                this._max = -150;
            this._snowEmmiter.setXSpeed(this._max - 20, this._max);
            this._snowEmmiter.forEachAlive(function (p) { _this.setParticleXSpeed(p); }, this, this._max);
        };
        EndGameScreen.prototype.setParticleXSpeed = function (particle) {
            particle.body.velocity.x = this._max - Math.floor(Math.random() * 30);
        };
        EndGameScreen.prototype.createStar = function (x, y) {
            this._starBoostArray.push(this.game.add.sprite(x + 100, y + 100, "GameAssets", "starBurstMC_10001"));
            this._starBoostArray[this._starBoostArray.length - 1].animations.add("gold", Phaser.Animation.generateFrameNames("starBurstMC_", 10001, 10047), 24 + this.game.rnd.integerInRange(-5, 10), true);
            this._starBoostArray[this._starBoostArray.length - 1].anchor.set(0.5, 1);
            this._starBoostArray[this._starBoostArray.length - 1].play("gold");
            this._bg.addChild(this._starBoostArray[this._starBoostArray.length - 1]);
        };
        EndGameScreen.prototype.shutdown = function () {
            this.clearTimeouts();
            if (this.game.device.desktop) {
                this._snowEmmiter.destroy(true);
            }
            this._bg.destroy(true);
        };
        EndGameScreen.prototype.update = function () {
            var dt = this.game.time.elapsedMS / 1000;
            if (this.game.device.desktop) {
                this._update_interval -= dt;
                if (this._update_interval <= 0) {
                    this.changeWindDirection();
                    this._update_interval = Math.floor(Math.random() * 20) * 60;
                }
            }
            _super.prototype.update.call(this);
        };
    ...
    TProject.EndGameScreen = EndGameScreen;
})(TProject || (TProject = {}));
...
(function (TProject) {
    var FinishScreen = (function (_super) {
        ...
        FinishScreen.prototype.create = function () {
            _super.prototype.create.call(this);
            TProject.SoundMixer.off();
            TProject.SoundMixer.play("sound 26 (sfx_applause)", 0.6);
            this._gotoAfterChoose = "";
        ...
        FinishScreen.prototype.myinit = function () {
            var _this = this;
            _super.prototype.init.call(this);
            this._playerPlace = TProject.Boot.GAME_DATA.winMedal;
            this._playerType = TProject.Boot.GAME_DATA.choosePlayer;
            this._bg = this.game.add.sprite(-7, 0, "GUI_Test", "podium_bg");
            this.game.stage.addChild(this._bg);
            ...
            this._exitBtn = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_exit_10001", "mc.btn_exit_10002", "mc.btn_exit_10002"], function () {
                TProject.Boot.GAME_DATA.currentMenuState = "MainMenuScreen";
                TProject.SaveManager.getInstance.save();
                _this._gotoAfterChoose = "MainMenuScreen";
                _this.clearAll();
            });
            this._exitBtn.position.set(40, 31);
            this._bg.addChild(this._exitBtn);
        ...
        FinishScreen.prototype.changeWindDirection = function () {
            var _this = this;
            var multi = Math.floor((this._max + 200) / 4), frag = (Math.floor(Math.random() * 100) - multi);
            this._max = this._max + frag;
            if (this._max > 200)
        ...
        FinishScreen.prototype.setParticleXSpeed = function (particle) {
            particle.body.velocity.x = this._max - Math.floor(Math.random() * 30);
        };
        FinishScreen.prototype.clearAll = function () {
            var _this = this;
            this._contininiueBtn.enabled = false;
            this._soundBtnOn.enabled = false;
            this._soundBtnOff.enabled = false;
            this._exitBtn.enabled = false;
            this.setTimeout(function () {
                _this.game.state.start(_this._gotoAfterChoose, true);
            }, 100);
        };
        FinishScreen.prototype.checkPlayerStatus = function () {
            var realLevel = 3 * (TProject.Boot.GAME_DATA.chooseWorld - 1) + TProject.Boot.GAME_DATA.chooseLevel - 1;
            if (realLevel + 1 == 9) {
                this._gotoAfterChoose = "EndGameScreen";
                if (TProject.Boot.GAME_DATA.levelsStatusArray[8] == 0) {
                    TProject.Boot.GAME_DATA.levelsStatusArray[8] = TProject.Boot.GAME_DATA.winMedal;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[8] = 1;
                    TProject.Boot.GAME_DATA.lastWorld = 4;
                    TProject.Boot.GAME_DATA.lastWorldStatus = true;
                    TProject.SaveManager.getInstance.save();
                }
                else {
                    if (TProject.Boot.GAME_DATA.levelsStatusArray[8] < TProject.Boot.GAME_DATA.winMedal) {
                        TProject.Boot.GAME_DATA.levelsStatusArray[8] = TProject.Boot.GAME_DATA.winMedal;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[8] = 1;
                        TProject.SaveManager.getInstance.save();
                    }
            ...
            else if (realLevel + 1 == 3 || realLevel + 1 == 6) {
                this._gotoAfterChoose = "MainMenuScreen";
                if (realLevel + 1 == 3 && TProject.Boot.GAME_DATA.levelsStatusArray[2] == 0) {
                    TProject.Boot.GAME_DATA.levelsStatusArray[2] = TProject.Boot.GAME_DATA.winMedal;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[2] = 1;
                    TProject.Boot.GAME_DATA.lastWorld = 2;
                    TProject.Boot.GAME_DATA.lastWorldStatus = false;
                    TProject.Boot.GAME_DATA.currentMenuState = "PickWorldScreen";
                    TProject.SaveManager.getInstance.save();
                }
                else if (realLevel + 1 == 6 && TProject.Boot.GAME_DATA.levelsStatusArray[5] == 0) {
                    TProject.Boot.GAME_DATA.levelsStatusArray[5] = TProject.Boot.GAME_DATA.winMedal;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[5] = 1;
                    TProject.Boot.GAME_DATA.lastWorld = 3;
                    TProject.Boot.GAME_DATA.lastWorldStatus = false;
                    TProject.Boot.GAME_DATA.currentMenuState = "PickWorldScreen";
                    TProject.SaveManager.getInstance.save();
                }
                else {
                    if (TProject.Boot.GAME_DATA.levelsStatusArray[realLevel] < TProject.Boot.GAME_DATA.winMedal) {
                        TProject.Boot.GAME_DATA.levelsStatusArray[realLevel] = TProject.Boot.GAME_DATA.winMedal;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[realLevel] = 0;
                    }
                    TProject.Boot.GAME_DATA.currentMenuState = "PickLevelScreen";
                    TProject.SaveManager.getInstance.save();
                }
            }
            else {
                this._gotoAfterChoose = "MainMenuScreen";
                if (TProject.Boot.GAME_DATA.levelsStatusArray[realLevel] == 0) {
                    TProject.Boot.GAME_DATA.levelsStatusArray[realLevel + 1] = 0;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[realLevel + 1] = 0;
                }
                if (TProject.Boot.GAME_DATA.levelsStatusArray[realLevel] < TProject.Boot.GAME_DATA.winMedal) {
                    TProject.Boot.GAME_DATA.levelsStatusArray[realLevel] = TProject.Boot.GAME_DATA.winMedal;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[realLevel] = 0;
        ...
        FinishScreen.prototype.shutdown = function () {
            this.clearTimeouts();
            this._podiumDB.free();
            this._currentMedal.free();
            this._otherMedal.free();
            this._otherMedal2.free();
            this._podium.destroy(true);
            this._miniSilver.destroy(true);
            this._miniGold.destroy(true);
            this._miniBronze.destroy(true);
            this._gumball.destroy(true);
            this._darwin.destroy(true);
            this._anais.destroy(true);
            if (this.game.device.desktop) {
                this._snowEmmiter.destroy(true);
            }
            this._confettiEmmiter.destroy(true);
            this._miniMedal.destroy(true);
            this._miniMedal2.destroy(true);
            this._bg.destroy(true);
        };
...
(function (TProject) {
    var MainMenuScreen = (function (_super) {
        ...
        MainMenuScreen.prototype.myinit = function () {
            var _this = this;
            _super.prototype.init.call(this);
            TProject.SoundMixer.off();
            TProject.SoundMixer.play("sound 28 (music_splash)", 0.5, true);
            this._chooseWorld = TProject.Boot.GAME_DATA.chooseWorld;
            this._chooseLevel = TProject.Boot.GAME_DATA.chooseLevel;
            this._choosePlayer = TProject.Boot.GAME_DATA.choosePlayer;
            this._winMedal = TProject.Boot.GAME_DATA.winMedal;
            this._currentMenuState = TProject.Boot.GAME_DATA.currentMenuState;
            this._lastWorld = TProject.Boot.GAME_DATA.lastWorld;
            this._lastWorldStatus = TProject.Boot.GAME_DATA.lastWorldStatus;
            this._levelsStatusArray = TProject.Boot.GAME_DATA.levelsStatusArray;
            this._levelsShowOpenedArray = TProject.Boot.GAME_DATA.levelsShowOpenedArray;
            this._worldSelectVisible = false;
            this._levelSelectVisible = false;
            this._playerSelectVisible = false;
            this._instructionsVisible = false;
            this._bgForMenu = this.game.add.sprite(0, 0, "GUI_Test", "MenuBG");
            this._mainMenuBG = this.game.add.sprite(0, 0, "GUI_Test", "mainMenuBG");
            this._helpBtn = new TProject.OButton(this.game, "GUI_Test", ["instructions_btn_10001", "instructions_btn_10002", "instructions_btn_10002"], function () {
                _this._helpBtn.enabled = false;
                _this._playBtn.enabled = false;
                _this._mainMenuBG.visible = false;
                _this._exitBtn.enabled = true;
                _this._exitBtn.visible = true;
                _this.openInstructions();
            });
            this._helpBtn.position.set(610, 365);
            this._mainMenuBG.addChild(this._helpBtn);
            this._playBtn = new TProject.OButton(this.game, "GUI_Test", ["play_btn_10001", "play_btn_10002", "play_btn_10002"], function () {
                _this._helpBtn.enabled = false;
                _this._playBtn.enabled = false;
                _this._mainMenuBG.visible = false;
                _this._exitBtn.enabled = true;
                _this._exitBtn.visible = true;
                _this.openChooseWorld();
            });
            this._playBtn.position.set(639, 459);
            this._mainMenuBG.addChild(this._playBtn);
            this._soundBtnOn = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_sound_10001", "mc.btn_sound_10002", "mc.btn_sound_10002"], function () {
                _this._soundBtnOff.visible = true;
                _this._soundBtnOff.enabled = true;
                _this._soundBtnOn.visible = false;
            ...
            this._exitBtn = new TProject.OButton(this.game, "GUI_Test", ["mc.btn_exit_10001", "mc.btn_exit_10002", "mc.btn_exit_10002"], function () {
                _this._exitBtn.enabled = false;
                _this._exitBtn.visible = false;
                _this._instructionsBackBtnOver.enabled = false;
                _this._instructionsDB.visible = false;
                _this._characterPrevOver.enabled = false;
                _this._characterNextOver.enabled = false;
                _this._characterBackBtnOver.enabled = false;
                _this._characterDoneOver.enabled = false;
                _this._chooseCharacter.visible = false;
                _this._levelBtn1Over.enabled = false;
                _this._levelBtn2Over.enabled = false;
                _this._levelBtn3Over.enabled = false;
                _this._levelBackBtnOver.enabled = false;
                _this._pickLevelDB.visible = false;
                _this._worldBtn3Over.enabled = false;
                _this._worldBtn2Over.enabled = false;
                _this._worldBtn1Over.enabled = false;
                _this._worlBackBtnOver.enabled = false;
                _this._choseWorldDB.visible = false;
                _this._worldSelectVisible = false;
                _this._levelSelectVisible = false;
                _this._playerSelectVisible = false;
                _this._instructionsVisible = false;
                _this.backToMainScreen();
            });
            this._exitBtn.position.set(40, 31);
            this._helpBtn.enabled = false;
            this._playBtn.enabled = false;
            this._mainMenuBG.visible = false;
            if (TProject.Boot.GAME_DATA.musicEnable) {
                this._soundBtnOn.visible = true;
                this._soundBtnOn.enabled = true;
            }
            ...
            switch (this._currentMenuState) {
                case "MainMenuScreen":
                    this._helpBtn.enabled = true;
                    this._playBtn.enabled = true;
                    this._mainMenuBG.visible = true;
                    this._exitBtn.enabled = false;
                    this._exitBtn.visible = false;
                    break;
                case "PickWorldScreen":
                    this._worldSelectVisible = true;
                    this._exitBtn.enabled = true;
                    this._exitBtn.visible = true;
                    break;
                case "PickLevelScreen":
            ...
            if (this.game.device.desktop) {
                ...
                this._snowEmmiter.maxRotation = 40;
                this._snowEmmiter.start(false, 6000, 250);
                this.game.stage.addChild(this._snowEmmiter);
                this.changeWindDirection();
            }
            this.game.stage.addChild(this._soundBtnOn);
            this.game.stage.addChild(this._soundBtnOff);
            this.game.stage.addChild(this._exitBtn);
        };
        MainMenuScreen.prototype.clearStage = function () {
            var _this = this;
            this._instructionsBackBtnOver.enabled = false;
            this._worldBtn1Over.enabled = false;
            this._worldBtn2Over.enabled = false;
            this._worldBtn3Over.enabled = false;
            this._worlBackBtnOver.enabled = false;
            this._levelBtn1Over.enabled = false;
            this._levelBtn2Over.enabled = false;
            this._levelBtn3Over.enabled = false;
            this._levelBackBtnOver.enabled = false;
            this._characterPrevOver.enabled = false;
            this._characterNextOver.enabled = false;
            this._characterDoneOver.enabled = false;
            this._characterBackBtnOver.enabled = false;
            this._playBtn.enabled = false;
            this._helpBtn.enabled = false;
            this._exitBtn.enabled = false;
            this._soundBtnOff.enabled = false;
        ...
        MainMenuScreen.prototype.shutdown = function () {
            if (this.game.device.desktop) {
                this._snowEmmiter.destroy(true);
            }
            this.clearTimeouts();
            this._exitBtn.destroy(true);
            this._soundBtnOff.destroy(true);
            this._soundBtnOn.destroy(true);
            this._bgForMenu.destroy(true);
            this._overlayForMenu.destroy(true);
            this._overlayForLevel.destroy(true);
            this._overlayForPlayer.destroy(true);
            this._overlayForInstructions.destroy(true);
            this._planeWorldSelect.destroy(true);
            this._planeLevelSelect.destroy(true);
            this._planeCharacterSelect.destroy(true);
            this._planeInstructions.destroy(true);
            this._mainMenuBG.destroy(true);
            this._instructionsDB.free();
            this._pickLevelDB.free();
            this._panelDBLevel.free();
            this._chooseCharacter.free();
        };
        MainMenuScreen.prototype.changeWindDirection = function () {
            var _this = this;
            var multi = Math.floor((this._max + 200) / 4), frag = (Math.floor(Math.random() * 100) - multi);
            this._max = this._max + frag;
            if (this._max > 200)
        ...
        MainMenuScreen.prototype.setParticleXSpeed = function (particle) {
            particle.body.velocity.x = this._max - Math.floor(Math.random() * 30);
        };
        MainMenuScreen.prototype.initPickWorld = function () {
            var _this = this;
            this._choseWorldDB = new TProject.DBSprite(TProject.Boot.TEST_INSTRUKTIONS_SCREEN, "pick_a_location/mc.pick_a_location", this.game);
            this._choseWorldDB.setPos(375.0, 250.0);
            if (this._worldSelectVisible) {
                TProject.SoundMixer.play("sound 27 (sfx_panel)", 0.6);
                this._choseWorldDB.play("idle", function () {
                    _this._worlBackBtnOver.enabled = true;
                    switch (_this._lastWorld) {
                        case 1:
                            if (_this._lastWorldStatus) {
                                _this._worldBtn1Over.enabled = true;
                            }
                            break;
                        case 2:
                            if (_this._lastWorldStatus) {
                                _this._worldBtn1Over.enabled = true;
                                _this._worldBtn2Over.enabled = true;
                            }
                            break;
                        case 3:
                            if (_this._lastWorldStatus) {
                                _this._worldBtn1Over.enabled = true;
                                _this._worldBtn2Over.enabled = true;
                                _this._worldBtn3Over.enabled = true;
                            }
                            break;
                        case 4:
                            if (_this._lastWorldStatus) {
            ...
            this._choseWorldDB.getSlot("back_btn").play("up");
            this._choseWorldDB.getSlot("title").play("choose_course");
            this.game.stage.addChild(this._choseWorldDB);
            this._overlayForMenu = this.game.add.sprite(4, 4, "GUI_Test", "MenuOverlay");
            this._planeWorldSelect = this.game.add.sprite(0, 0, "GUI_Test", "chooseLocationPanel");
            this._planeWorldSelect.anchor.set(0.5);
            this._choseWorldDB.getBone("trim_top").addChild(this._overlayForMenu);
            this._choseWorlPanelDB = new TProject.DBSprite(this._choseWorldDB.getBone("panel"));
            this._choseWorlPanelDB.getBone("Layer 1").addChild(this._planeWorldSelect);
            this._pathDotsWorlPanelDB = new TProject.DBSprite(this._choseWorlPanelDB.getBone("path_dots"));
            this._choseWorlPanelDB.getSlot("world_1").play("lock");
            this._choseWorlPanelDB.getSlot("world_2").play("lock");
            this._choseWorlPanelDB.getSlot("world_3").play("lock");
            this._choseWorlPanelDB.getBone("world_1").armature.getSlot("rollover").childArmature.animation.play("up");
            this._choseWorlPanelDB.getBone("world_2").armature.getSlot("rollover").childArmature.animation.play("up");
            this._choseWorlPanelDB.getBone("world_3").armature.getSlot("rollover").childArmature.animation.play("up");
            this._choseWorlPanelDB.getBone("world_1").armature.getSlot("locations_new").childArmature.animation.play("world_1");
            this._choseWorlPanelDB.getBone("world_2").armature.getSlot("locations_new").childArmature.animation.play("world_2");
            this._choseWorlPanelDB.getBone("world_3").armature.getSlot("locations_new").childArmature.animation.play("world_3");
            var buttonDBTest = new TProject.DBSprite(this._choseWorlPanelDB.getBone("world_1"));
            var buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("rollover"));
            this._worldBtn1Over = new TProject.OverlayButton(this.game, buttonDBTest2, 140, 140, ["up", "over", "up", "over"], function () {
                _this._worldBtn1Over.enabled = false;
                _this._chooseWorld = 1;
                TProject.Boot.GAME_DATA.chooseWorld = 1;
                TProject.SaveManager.getInstance.save();
                _this.gotoChooseLevel();
            }, this);
            this._worldBtn1Over.enabled = false;
            buttonDBTest.getBone("rollover").addChild(this._worldBtn1Over);
            this._worldBtn1Over.setPos(10, 15);
            buttonDBTest = new TProject.DBSprite(this._choseWorlPanelDB.getBone("world_2"));
            buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("rollover"));
            this._worldBtn2Over = new TProject.OverlayButton(this.game, buttonDBTest2, 140, 140, ["up", "over", "up", "over"], function () {
                _this._worldBtn2Over.enabled = false;
                _this._chooseWorld = 2;
                TProject.Boot.GAME_DATA.chooseWorld = 2;
                TProject.SaveManager.getInstance.save();
                _this.gotoChooseLevel();
            }, this);
            this._worldBtn2Over.enabled = false;
            buttonDBTest.getBone("rollover").addChild(this._worldBtn2Over);
            this._worldBtn2Over.setPos(10, 15);
            buttonDBTest = new TProject.DBSprite(this._choseWorlPanelDB.getBone("world_3"));
            buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("rollover"));
            this._worldBtn3Over = new TProject.OverlayButton(this.game, buttonDBTest2, 140, 140, ["up", "over", "up", "over"], function () {
                _this._worldBtn3Over.enabled = false;
                _this._chooseWorld = 3;
                TProject.Boot.GAME_DATA.chooseWorld = 3;
                TProject.SaveManager.getInstance.save();
                _this.gotoChooseLevel();
            }, this);
            this._worldBtn3Over.enabled = false;
            buttonDBTest.getBone("rollover").addChild(this._worldBtn3Over);
            this._worldBtn3Over.setPos(10, 15);
            buttonDBTest = new TProject.DBSprite(this._choseWorldDB.getBone("back_btn"));
            this._worlBackBtnOver = new TProject.OverlayButton(this.game, buttonDBTest, 120, 100, ["up", "over", "up", "over"], function () {
                _this._worlBackBtnOver.enabled = false;
                _this._worldBtn3Over.enabled = false;
                _this._worldBtn2Over.enabled = false;
                _this._worldBtn1Over.enabled = false;
            ...
            this._worlBackBtnOver.enabled = false;
            this._choseWorldDB.getBone("back_btn").addChild(this._worlBackBtnOver);
            this._worlBackBtnOver.setPos(10, 0);
            this._choseWorlPanelDB.getBone("world_1").armature.getBone("slot_1").visible = false;
            this._choseWorlPanelDB.getBone("world_1").armature.getBone("slot_2").visible = false;
            this._choseWorlPanelDB.getBone("world_1").armature.getBone("slot_3").visible = false;
            this._choseWorlPanelDB.getBone("world_2").armature.getBone("slot_1").visible = false;
            this._choseWorlPanelDB.getBone("world_2").armature.getBone("slot_2").visible = false;
            this._choseWorlPanelDB.getBone("world_2").armature.getBone("slot_3").visible = false;
            this._choseWorlPanelDB.getBone("world_3").armature.getBone("slot_1").visible = false;
            this._choseWorlPanelDB.getBone("world_3").armature.getBone("slot_2").visible = false;
            this._choseWorlPanelDB.getBone("world_3").armature.getBone("slot_3").visible = false;
            if (this._worldSelectVisible) {
                switch (this._lastWorld) {
                    case 1:
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_1_open", function () { _this.medalCheck(1); });
                            this._choseWorlPanelDB.getSlot("world_1").play("unlocked");
                            this._choseWorlPanelDB.getBone("world_1").armature.getSlot("locations_new").childArmature.animation.play("world_1");
                        }
                        else {
                            this._pathDotsWorlPanelDB.play("world_1", function () {
                                _this._choseWorlPanelDB.getSlot("world_1").play("unlock");
                                _this._choseWorlPanelDB.getBone("world_1").armature.getSlot("locations_new").childArmature.animation.play("world_1");
                                _this._worldBtn1Over.enabled = true;
                                _this._lastWorldStatus = true;
                                TProject.Boot.GAME_DATA.lastWorldStatus = true;
                                TProject.SaveManager.getInstance.save();
                            }, this);
                        }
                    ...
                    case 2:
                        this.worldIsOpen(1);
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_2_open", function () { _this.medalCheck(2); });
                            this._choseWorlPanelDB.getSlot("world_2").play("unlocked");
                            this._choseWorlPanelDB.getBone("world_2").armature.getSlot("locations_new").childArmature.animation.play("world_2");
                        }
                        else {
                            this._pathDotsWorlPanelDB.play("world_2", function () {
                                _this._choseWorlPanelDB.getSlot("world_2").play("unlock");
                                _this._choseWorlPanelDB.getBone("world_2").armature.getSlot("locations_new").childArmature.animation.play("world_2");
                                _this._worldBtn2Over.enabled = true;
                                _this._lastWorldStatus = true;
                                TProject.Boot.GAME_DATA.lastWorldStatus = true;
                                TProject.SaveManager.getInstance.save();
                    ...
                    case 3:
                        ...
                        this.worldIsOpen(2);
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("world_3_open", function () { _this.medalCheck(3); });
                            this._choseWorlPanelDB.getSlot("world_3").play("unlocked");
                            this._choseWorlPanelDB.getBone("world_3").armature.getSlot("locations_new").childArmature.animation.play("world_3");
                        }
                        else {
                            this._pathDotsWorlPanelDB.play("world_3", function () {
                                _this._choseWorlPanelDB.getSlot("world_3").play("unlock");
                                _this._choseWorlPanelDB.getBone("world_3").armature.getSlot("locations_new").childArmature.animation.play("world_3");
                                _this._worldBtn3Over.enabled = true;
                                _this._lastWorldStatus = true;
                                TProject.Boot.GAME_DATA.lastWorldStatus = true;
                                TProject.SaveManager.getInstance.save();
                    ...
                    case 4:
                        ...
                        this.worldIsOpen(3);
                        if (this._lastWorldStatus) {
                            this._pathDotsWorlPanelDB.play("game_complete_open");
                        }
                        else {
                            this._lastWorldStatus = true;
                            this._pathDotsWorlPanelDB.play("game_complete");
                        }
                        break;
                }
            }
            if (!this._worldSelectVisible)
                this._choseWorldDB.visible = false;
        };
        MainMenuScreen.prototype.gotoChooseLevel = function () {
            this._worldBtn3Over.enabled = false;
            this._worldBtn2Over.enabled = false;
            this._worldBtn1Over.enabled = false;
            this._worlBackBtnOver.enabled = false;
            this._choseWorldDB.visible = false;
            this.openChooseLevel();
        };
        MainMenuScreen.prototype.openChooseWorld = function () {
            var _this = this;
            if (!this._worldSelectVisible) {
                this._worldSelectVisible = true;
                if (this._worldSelectVisible) {
            ...
            this._choseWorldDB.visible = true;
        };
        MainMenuScreen.prototype.worldIsOpen = function (currentWord) {
            this._pathDotsWorlPanelDB.play("world_" + currentWord + "_open");
            this._choseWorlPanelDB.getSlot("world_" + currentWord).play("unlocked");
            this._choseWorlPanelDB.getBone("world_" + currentWord).armature.getSlot("locations_new").childArmature.animation.play("world_" + currentWord);
            this.medalCheck(currentWord);
        };
        MainMenuScreen.prototype.medalCheck = function (currentWord) {
            for (var i = 1; i < 4; i++) {
                var status_1 = this._levelsStatusArray[3 * (currentWord - 1) + i - 1];
                if (status_1 > 0) {
                    if (status_1 == 1) {
                        this._choseWorlPanelDB.getBone("world_" + currentWord).armature.getSlot("slot_" + i).childArmature.animation.play("bronze");
                    }
                    else if (status_1 == 2) {
                        this._choseWorlPanelDB.getBone("world_" + currentWord).armature.getSlot("slot_" + i).childArmature.animation.play("silver");
                    }
                    else {
                        this._choseWorlPanelDB.getBone("world_" + currentWord).armature.getSlot("slot_" + i).childArmature.animation.play("gold");
                    }
                    this._choseWorlPanelDB.getBone("world_" + currentWord).armature.getBone("slot_" + i).visible = true;
                }
            }
        };
        MainMenuScreen.prototype.initPickLevel = function () {
            var _this = this;
            this._pickLevelDB = new TProject.DBSprite(TProject.Boot.TEST_INSTRUKTIONS_SCREEN, "pick_a_level/mc.pick_a_level", this.game);
            this._pickLevelDB.setPos(375.0, 250.0);
            this._panelDBLevel = new TProject.DBSprite(this._pickLevelDB.getBone("panel"));
            var buttonDBTest = new TProject.DBSprite(this._panelDBLevel.getBone("level_1"));
            var buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("bar"));
            this._levelBtn1Over = new TProject.OverlayButton(this.game, buttonDBTest2, 300, 55, ["bg1_up", "bg1_over", "bg1_up", "bg1_over"], function () {
                _this._chooseLevel = 1;
                TProject.Boot.GAME_DATA.chooseLevel = 1;
                TProject.SaveManager.getInstance.save();
                _this.gtotCharsSelect();
            }, this);
            this._levelBtn1Over.enabled = false;
            buttonDBTest.getBone("bar").addChild(this._levelBtn1Over);
            buttonDBTest = new TProject.DBSprite(this._panelDBLevel.getBone("level_2"));
            buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("bar"));
            this._levelBtn2Over = new TProject.OverlayButton(this.game, buttonDBTest2, 300, 55, ["bg2_up", "bg2_over", "bg2_up", "bg2_over"], function () {
                _this._chooseLevel = 2;
                TProject.Boot.GAME_DATA.chooseLevel = 2;
                TProject.SaveManager.getInstance.save();
                _this.gtotCharsSelect();
            }, this);
            this._levelBtn2Over.enabled = false;
            buttonDBTest.getBone("bar").addChild(this._levelBtn2Over);
            buttonDBTest = new TProject.DBSprite(this._panelDBLevel.getBone("level_3"));
            buttonDBTest2 = new TProject.DBSprite(buttonDBTest.getBone("bar"));
            this._levelBtn3Over = new TProject.OverlayButton(this.game, buttonDBTest2, 300, 55, ["bg3_up", "bg3_over", "bg3_up", "bg3_over"], function () {
                _this._chooseLevel = 3;
                TProject.Boot.GAME_DATA.chooseLevel = 3;
                TProject.SaveManager.getInstance.save();
                _this.gtotCharsSelect();
            }, this);
            this._levelBtn3Over.enabled = false;
            buttonDBTest.getBone("bar").addChild(this._levelBtn3Over);
            buttonDBTest = new TProject.DBSprite(this._pickLevelDB.getBone("back_btn"));
            this._levelBackBtnOver = new TProject.OverlayButton(this.game, buttonDBTest, 120, 100, ["up", "over", "up", "over"], function () {
                _this._levelBackBtnOver.enabled = false;
                _this.closeChooseLevelandOpenChooseWorld();
            }, this);
            this._levelBackBtnOver.enabled = false;
            this._pickLevelDB.getBone("back_btn").addChild(this._levelBackBtnOver);
            this._levelBackBtnOver.setPos(10, 0);
            if (this._levelSelectVisible) {
                TProject.SoundMixer.play("sound 27 (sfx_panel)", 0.6);
                this._pickLevelDB.play("idle", function () {
                    _this._levelBackBtnOver.enabled = true;
                    _this._panelDBLevel.play("open_labels", function () {
                        _this.updateMedalsToEndCallBack();
                    }, _this);
                }, this);
            }
            this._pickLevelDB.getSlot("back_btn").play("up");
            this._pickLevelDB.getSlot("title").play("choose_level");
            this.game.stage.addChild(this._pickLevelDB);
            this._overlayForLevel = this.game.add.sprite(4, 4, "GUI_Test", "MenuOverlay");
            this._planeLevelSelect = this.game.add.sprite(0, 0, "GUI_Test", "chooseLevelPanel");
            this._pickLevelDB.getBone("trim_top").addChild(this._overlayForLevel);
            this._panelDBLevel.getBone("panel").addChild(this._planeLevelSelect);
            this._panelDBLevel.getSlot("locations").play("world_" + this._chooseWorld);
            this._panelDBLevel.getSlot("level_1").play("locked");
            if (this._chooseWorld == 1) {
                this._panelDBLevel.getBone("level_1").armature.getSlot("text_post").childArmature.animation.play("A1");
                this._panelDBLevel.getBone("level_2").armature.getSlot("text_post").childArmature.animation.play("A2");
                this._panelDBLevel.getBone("level_3").armature.getSlot("text_post").childArmature.animation.play("A3");
            }
            else if (this._chooseWorld == 2) {
                this._panelDBLevel.getBone("level_1").armature.getSlot("text_post").childArmature.animation.play("B1");
                this._panelDBLevel.getBone("level_2").armature.getSlot("text_post").childArmature.animation.play("B2");
                this._panelDBLevel.getBone("level_3").armature.getSlot("text_post").childArmature.animation.play("B3");
            }
            else {
                this._panelDBLevel.getBone("level_1").armature.getSlot("text_post").childArmature.animation.play("C1");
                this._panelDBLevel.getBone("level_2").armature.getSlot("text_post").childArmature.animation.play("C2");
                this._panelDBLevel.getBone("level_3").armature.getSlot("text_post").childArmature.animation.play("C3");
            }
            this._panelDBLevel.getSlot("level_2").play("locked");
            this._panelDBLevel.getSlot("level_3").play("locked");
            var maskRectangle = this.game.add.graphics(0, 0);
            maskRectangle.beginFill(0x00ff00, 0.7);
            maskRectangle.drawRect(340, 233, 392, 300);
            maskRectangle.endFill();
            this._panelDBLevel.getBone("locations").addChild(maskRectangle);
            this._panelDBLevel.getBone("level_1").mask = maskRectangle;
            this._panelDBLevel.getBone("level_2").mask = maskRectangle;
            this._panelDBLevel.getBone("level_3").mask = maskRectangle;
            if (this._levelSelectVisible) {
                this.updateMedalsToStartLevel();
            }
            else {
                this._pickLevelDB.visible = false;
            }
        };
        MainMenuScreen.prototype.gtotCharsSelect = function () {
            this._levelBtn1Over.enabled = false;
            this._levelBtn2Over.enabled = false;
            this._levelBtn3Over.enabled = false;
            this._levelBackBtnOver.enabled = false;
        ...
        MainMenuScreen.prototype.updateMedalsToStartLevel = function () {
            for (var i = 1; i < 4; i++) {
                var lIndex = 3 * (this._chooseWorld - 1) + i - 1;
                var currentLevelToCheck = this._levelsStatusArray[lIndex];
                var currentLevelShow = this._levelsShowOpenedArray[lIndex];
                if (currentLevelToCheck == -1 && i == 1) {
                    this._levelsShowOpenedArray[lIndex] = 0;
                    this._levelsStatusArray[lIndex] = 0;
                    TProject.Boot.GAME_DATA.levelsShowOpenedArray[lIndex] = 0;
                    TProject.Boot.GAME_DATA.levelsStatusArray[lIndex] = 0;
                    TProject.SaveManager.getInstance.save();
                }
                if (currentLevelShow > 0) {
                    if (currentLevelToCheck == 0) {
                        this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("unlocked");
                    }
                    else if (currentLevelToCheck == 1) {
                        this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("bronze_waiting");
                    }
                    else if (currentLevelToCheck == 2) {
                        this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("silver_waiting");
                    }
                    else if (currentLevelToCheck == 3) {
                        this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("gold_waiting");
                    }
                }
                else if (currentLevelShow == 0) {
                    if (currentLevelToCheck > 0) {
                        this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("unlocked");
                    }
                }
        ...
        MainMenuScreen.prototype.updateMedalsToEndCallBack = function () {
            var _this = this;
            var _loop_1 = function (i) {
                var lIndex = 3 * (this_1._chooseWorld - 1) + i - 1;
                var currentLevelToCheck = this_1._levelsStatusArray[lIndex];
                var currentLevelShow = this_1._levelsShowOpenedArray[lIndex];
                if (currentLevelShow == 0) {
                    if (currentLevelToCheck == 0) {
                        this_1._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("unlock");
                        this_1._levelsShowOpenedArray[lIndex] = 1;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[lIndex] = 1;
                        TProject.SaveManager.getInstance.save();
                        this_1.setTimeout(function () {
                            _this.enebledLevelSelectButton(i);
                        }, 500);
                    }
                    else if (currentLevelToCheck == 1) {
                        this_1._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("bronze");
                        this_1._levelsShowOpenedArray[lIndex] = 1;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[lIndex] = 1;
                        TProject.SaveManager.getInstance.save();
                        this_1.setTimeout(function () {
                            _this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("bronze_waiting");
                            _this.enebledLevelSelectButton(i);
                        }, 500);
                    }
                    else if (currentLevelToCheck == 2) {
                        this_1._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("silver");
                        this_1._levelsShowOpenedArray[lIndex] = 1;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[lIndex] = 1;
                        TProject.SaveManager.getInstance.save();
                        this_1.setTimeout(function () {
                            _this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("silver_waiting");
                            _this.enebledLevelSelectButton(i);
                        }, 500);
                    }
                    else if (currentLevelToCheck == 3) {
                        this_1._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("gold");
                        this_1._levelsShowOpenedArray[lIndex] = 1;
                        TProject.Boot.GAME_DATA.levelsShowOpenedArray[lIndex] = 1;
                        TProject.SaveManager.getInstance.save();
                        this_1.setTimeout(function () {
                            _this._pickLevelDB.getBone("panel").armature.getSlot("level_" + i).childArmature.animation.play("gold_waiting");
                            _this.enebledLevelSelectButton(i);
                        }, 500);
                    }
                }
                else if (currentLevelShow == 1) {
                    if (currentLevelToCheck >= 0) {
                        this_1.enebledLevelSelectButton(i);
                    }
                }
            };
            var this_1 = this;
        ...
        MainMenuScreen.prototype.enebledLevelSelectButton = function (level) {
            if (this._pickLevelDB.visible) {
                if (level == 1) {
                    this._levelBtn1Over.enabled = true;
                }
                else if (level == 2) {
                    this._levelBtn2Over.enabled = true;
                }
                else if (level == 3) {
                    this._levelBtn3Over.enabled = true;
                }
            }
        };
        MainMenuScreen.prototype.closeChooseLevelandOpenChooseWorld = function () {
            this._levelBtn1Over.enabled = false;
            this._levelBtn2Over.enabled = false;
            this._levelBtn3Over.enabled = false;
            this._levelBackBtnOver.enabled = false;
            this._pickLevelDB.visible = false;
            this.openChooseWorld();
        };
        MainMenuScreen.prototype.openChooseLevel = function () {
            var _this = this;
            if (!this._levelSelectVisible)
                this._levelSelectVisible = true;
            if (this._pickLevelDB) {
                TProject.SoundMixer.play("sound 27 (sfx_panel)", 0.6);
                this._pickLevelDB.play("idle", function () {
                    _this._levelBackBtnOver.enabled = true;
                    _this._panelDBLevel.play("open_labels", function () {
                ...
                this._panelDBLevel.getSlot("level_2").play("locked");
                this._panelDBLevel.getSlot("level_3").play("locked");
                this.setTimeout(function () { _this.updateMedalsToStartLevel(); }, 100);
                this._pickLevelDB.visible = true;
            }
        };
        MainMenuScreen.prototype.initChooseCharacter = function () {
            var _this = this;
            this._statsTweensArray = [];
            this._chooseCharacter = new TProject.DBSprite(TProject.Boot.TEST_INSTRUKTIONS_SCREEN, "pick_a_character/mc.ui_pick_a_character", this.game);
            this._chooseCharacter.setPos(375.0, 250.0);
            this._chooseCharacter.play("idle", function () {
                _this._chooseCharacter.play("show_chars");
                _this._characterPrevOver.enabled = true;
                _this._characterNextOver.enabled = true;
                _this._characterBackBtnOver.enabled = true;
                _this._characterDoneOver.enabled = true;
            });
            this._chooseCharacter.getSlot("back_btn").play("up");
            this._chooseCharacter.getSlot("title").play("choose_character");
            this.game.stage.addChild(this._chooseCharacter);
            this._overlayForPlayer = this.game.add.sprite(4, 4, "GUI_Test", "MenuOverlay");
            this._planeCharacterSelect = this.game.add.sprite(0, 0, "GUI_Test", "choosePlayerPanel");
            this._chooseCharacter.getBone("trim_top").addChild(this._overlayForPlayer);
            this._chooseCharacter.getBone("panel").addChild(this._planeCharacterSelect);
            this._chooseCharacter.getBone("characters").armature.getSlot("Layer 1 copy").childArmature.animation.play("char_" + this._choosePlayer);
            this._chooseCharacter.getBone("Stats").armature.getSlot("name_tag").childArmature.animation.play("char_" + this._choosePlayer);
            var buttonDBTest = new TProject.DBSprite(this._chooseCharacter.getBone("btn_left_arrow"));
            this._characterPrevOver = new TProject.OverlayButton(this.game, buttonDBTest, 60, 80, ["up", "over", "up", "over"], function () {
                _this._choosePlayer -= 1;
                if (_this._choosePlayer < 1)
                    _this._choosePlayer = 3;
                _this._chooseCharacter.getSlot("characters").play("show_chars");
                _this._chooseCharacter.getBone("characters").armature.getSlot("Layer 1 copy").childArmature.animation.play("char_" + _this._choosePlayer);
                _this._chooseCharacter.getBone("Stats").armature.getSlot("name_tag").childArmature.animation.play("char_" + _this._choosePlayer);
                _this.checkStatesChange(_this._choosePlayer);
            }, this);
            this._characterPrevOver.enabled = false;
            this._chooseCharacter.getBone("btn_left_arrow").addChild(this._characterPrevOver);
            this._characterPrevOver.setPos(5, 0);
            buttonDBTest = new TProject.DBSprite(this._chooseCharacter.getBone("btn_right_arrow"));
            this._characterNextOver = new TProject.OverlayButton(this.game, buttonDBTest, 60, 80, ["up", "over", "up", "over"], function () {
                _this._choosePlayer += 1;
                if (_this._choosePlayer > 3)
                    _this._choosePlayer = 1;
                _this._chooseCharacter.getSlot("characters").play("show_chars");
                _this._chooseCharacter.getBone("characters").armature.getSlot("Layer 1 copy").childArmature.animation.play("char_" + _this._choosePlayer);
                _this._chooseCharacter.getBone("Stats").armature.getSlot("name_tag").childArmature.animation.play("char_" + _this._choosePlayer);
            ...
            this._characterNextOver.enabled = false;
            this._chooseCharacter.getBone("btn_right_arrow").addChild(this._characterNextOver);
            this._characterNextOver.setPos(5, 0);
            buttonDBTest = new TProject.DBSprite(this._chooseCharacter.getBone("back_btn"));
            this._characterBackBtnOver = new TProject.OverlayButton(this.game, buttonDBTest, 120, 100, ["up", "over", "up", "over"], function () {
                _this._characterBackBtnOver.enabled = true;
                _this.backToLevelSelect();
            }, this);
            this._characterBackBtnOver.enabled = false;
            this._chooseCharacter.getBone("back_btn").addChild(this._characterBackBtnOver);
            this._characterBackBtnOver.setPos(10, 0);
            buttonDBTest = new TProject.DBSprite(this._chooseCharacter.getBone("btn_select"));
            this._characterDoneOver = new TProject.OverlayButton(this.game, buttonDBTest, 240, 90, ["up", "over", "up", "over"], function () {
                _this._characterDoneOver.enabled = false;
                _this._chooseCharacter.getBone("characters").armature.getSlot("Layer 4").childArmature.animation.play("char_" + _this._choosePlayer);
                _this._chooseCharacter.getSlot("characters").play("outro");
                _this._characterPrevOver.enabled = false;
                _this._characterNextOver.enabled = false;
                _this._characterBackBtnOver.enabled = false;
                _this._exitBtn.enabled = false;
                _this._soundBtnOff.enabled = false;
                _this._soundBtnOn.enabled = false;
                TProject.Boot.GAME_DATA.choosePlayer = _this._choosePlayer;
                TProject.SaveManager.getInstance.save();
                _this.setTimeout(function () { _this.clearStage(); }, 800);
            }, this);
            this._characterDoneOver.enabled = false;
            this._chooseCharacter.getBone("btn_select").addChild(this._characterDoneOver);
            this._characterDoneOver.setPos(-140, -70);
            this._turnStat = this.game.add.graphics(-86, -11);
            this._turnStat.beginFill(0xffffff, 1);
            this._turnStat.drawRect(0, 0, 172, 27);
            this._turnStat.endFill();
            this._turnStat.tint = 0xFF0000;
            this._axelStat = this.game.add.graphics(-86, -11);
            this._axelStat.beginFill(0xffffff, 1);
            this._axelStat.drawRect(0, 0, 172, 27);
            this._axelStat.endFill();
            this._axelStat.tint = 0xFF0000;
            this._speedStat = this.game.add.graphics(-86, -11);
            this._speedStat.beginFill(0xffffff, 1);
            this._speedStat.drawRect(0, 0, 172, 27);
            this._speedStat.endFill();
            this._speedStat.tint = 0xFF0000;
            var stats0 = new TProject.DBSprite(this._chooseCharacter.getBone("Stats"));
            var stats1 = new TProject.DBSprite(stats0.getBone("turning_bar"));
            stats1.getBone("colour fill").addChild(this._turnStat);
            stats0 = new TProject.DBSprite(this._chooseCharacter.getBone("Stats"));
            stats1 = new TProject.DBSprite(stats0.getBone("acceleration_bar"));
            stats1.getBone("colour fill").addChild(this._axelStat);
            stats0 = new TProject.DBSprite(this._chooseCharacter.getBone("Stats"));
            stats1 = new TProject.DBSprite(stats0.getBone("speed_bar"));
            stats1.getBone("colour fill").addChild(this._speedStat);
            this._turnStat.scale.set(0.01, 1);
            this._axelStat.scale.set(0.01, 1);
            this._speedStat.scale.set(0.01, 1);
            if (!this._playerSelectVisible) {
                this._chooseCharacter.visible = false;
            }
            else {
                this.setTimeout(function () { _this.checkStatesChange(_this._choosePlayer); }, 200);
            }
        };
        MainMenuScreen.prototype.openCharSelect = function () {
            var _this = this;
            if (!this._playerSelectVisible)
                this._playerSelectVisible = true;
            TProject.SoundMixer.play("sound 27 (sfx_panel)", 0.6);
            this._chooseCharacter.play("idle", function () {
                _this._chooseCharacter.play("show_chars");
                _this._characterPrevOver.enabled = true;
            ...
            this._axelStat.scale.set(0.01, 1);
            this._speedStat.scale.set(0.01, 1);
            this._chooseCharacter.visible = true;
            this.setTimeout(function () { _this.checkStatesChange(_this._choosePlayer); }, 200);
        };
        MainMenuScreen.prototype.backToLevelSelect = function () {
            this._characterPrevOver.enabled = false;
            this._characterNextOver.enabled = false;
            this._characterBackBtnOver.enabled = false;
            this._characterDoneOver.enabled = false;
        ...
        MainMenuScreen.prototype.checkStatesChange = function (character) {
            if (character == 1) {
                this.stateChangeTween([this._turnStat, this._axelStat, this._speedStat], [0.85, 0.65, 0.70], [0x9eff00, 0xd4ff00, 0xc6ff00]);
            }
            else if (character == 2) {
                this.stateChangeTween([this._turnStat, this._axelStat, this._speedStat], [0.50, 0.85, 0.60], [0xfcff00, 0x9eff00, 0xe1ff00]);
            }
            else {
                this.stateChangeTween([this._turnStat, this._axelStat, this._speedStat], [0.65, 0.75, 0.80], [0xd4ff00, 0xb9ff00, 0xacff00]);
            }
        };
        MainMenuScreen.prototype.stateStopTweens = function () {
            var _this = this;
            if (this._statsTweensArray.length > 0) {
                this._statsTweensArray.forEach(function (tween) {
                    tween.stop();
                    _this.tweens.remove(tween);
                });
                this._statsTweensArray = [];
            }
        };
        MainMenuScreen.prototype.stateChangeTween = function (statRect, scaleTo, colourTo) {
            this.stateStopTweens();
            for (var i = 0; i < statRect.length; i++) {
                this._statsTweensArray.push(this.game.add.tween(statRect[i].scale).to({ x: scaleTo[i] }, 250, Phaser.Easing.Sinusoidal.Out, true));
                this._statsTweensArray.push(this.tweenTint(statRect[i], statRect[i].tint, colourTo[i]));
            }
        };
        MainMenuScreen.prototype.tweenTint = function (obj, startColor, endColor, time, callback) {
        ...
        MainMenuScreen.prototype.initInstructions = function () {
            var _this = this;
            this._instructionsDB = new TProject.DBSprite(TProject.Boot.TEST_INSTRUKTIONS_SCREEN, "instructions/mc.instructions", this.game);
            this._instructionsDB.setPos(375.0, 250.0);
            this._instructionsDB.play("idle", function () {
                _this._instructionsBackBtnOver.enabled = true;
            }, this);
            this._instructionsDB.getSlot("back_btn").play("up");
            this._instructionsDB.getSlot("title").play("instructions");
            this.game.stage.addChild(this._instructionsDB);
            this._overlayForInstructions = this.game.add.sprite(4, 4, "GUI_Test", "MenuOverlay");
            this._planeInstructions = this.game.add.sprite(0, 0, "GUI_Test", "InstructionsPanel");
            this._instructionsDB.getBone("trim_top").addChild(this._overlayForInstructions);
            this._instructionsDB.getBone("panel").addChild(this._planeInstructions);
            var buttonDBTest = new TProject.DBSprite(this._instructionsDB.getBone("back_btn"));
            this._instructionsBackBtnOver = new TProject.OverlayButton(this.game, buttonDBTest, 120, 100, ["up", "over", "up", "over"], function () {
                _this._instructionsBackBtnOver.enabled = false;
                _this._instructionsDB.visible = false;
                _this.backToMainScreen();
            }, this);
            this._instructionsBackBtnOver.enabled = false;
            this._instructionsDB.getBone("back_btn").addChild(this._instructionsBackBtnOver);
            this._instructionsBackBtnOver.setPos(10, 0);
            if (!this._instructionsVisible)
                this._instructionsDB.visible = false;
        };
        MainMenuScreen.prototype.openInstructions = function () {
            var _this = this;
            TProject.SoundMixer.play("sound 27 (sfx_panel)", 0.6);
            this._instructionsDB.play("idle", function () {
                _this._instructionsBackBtnOver.enabled = true;
            }, this);
            this._instructionsDB.visible = true;
        };
        MainMenuScreen.prototype.backToMainScreen = function () {
            this._exitBtn.enabled = false;
            this._exitBtn.visible = false;
            this._mainMenuBG.visible = true;
            this._playBtn.enabled = true;
    ...
    TProject.MainMenuScreen = MainMenuScreen;
})(TProject || (TProject = {}));
...
(function (TProject) {
    var Preloader = (function (_super) {
        ...
        Preloader.prototype.preload = function () {
            ...
            this.game.load.atlas("finish_chars", TProject.Boot.PATH_IMAGES + "finish.png", TProject.Boot.PATH_IMAGES + "finish.json");
            this.game.load.atlas("GUI_Test", TProject.Boot.PATH_IMAGES + "gui.png", TProject.Boot.PATH_IMAGES + "gui.json");
            ...
            TProject.Factories.loadFactory(this.game, "instructions_test", TProject.Boot.PATH_IMAGES + "DB/");
        };
        ...
        Preloader.prototype.loadingUpdate = function (progress, cacheKey, success, totalLoaded, totalFiles) {
            ...
            if (progress >= 100.0) {
                ...
                TProject.Boot.TEST_INSTRUKTIONS_SCREEN = TProject.Factories.createFactory(this.game, "instructions_test");
                dragonBones.PhaserFactory.startLoop();
        ...
        Preloader.prototype.fontsLoading = function () {
            ...
            WebFont.load({
                custom: {
                    families: ["FredFredburgerAraHeadW21-Blk"],
                    urls: [
                        TProject.Boot.PATH_FONTS + "styles.css"
                    ]
                },
                active: function () {
